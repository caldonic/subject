...
import subject.walletrecord.model.WalletrecordVO;
...
public class TicketDAO implements TicketDAO_interface{
		...
		private static final String GET_ALL_STMT = 
				"select omf.order_serial_number,order_detail_serial_number,item_name,order_date,order_status_name from order_main_file omf join order_detail od on omf.order_serial_number = od.order_serial_number join item i on od.item_serial_number = i.item_serial_number join order_status os on omf.order_status_number = os.order_status_number";
