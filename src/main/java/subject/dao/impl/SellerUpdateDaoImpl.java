...
public class SellerUpdateDaoImpl implements SellerUpdateDao {
	...
	final String UPDATE_SELLER = "UPDATE letitgo.seller set seller_serial_number=?,company_name=?, company_member_account=?, company_member_password=?, id_number=?, seller_email=?, company_holder=?, company_holder_id=?, seller_phone_number=?, seller_main_address=?, seller_branch_address=?, store_description=? where seller_serial_number = ?";
