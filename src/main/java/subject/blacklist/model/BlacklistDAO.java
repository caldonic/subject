...
//			pstmt.setString(4, blacklistVO.getAccount());
	...
	public BlacklistVO findMemberserialnumber(Integer memberserialnumber) {
		...
		try {
			...
			while (rs.next()) {
				...
				blacklistVO.setBlacklistnumber(rs.getInt("black_list_number"));
				blacklistVO.setSerialnumber(rs.getInt("seller_serial_number"));
				blacklistVO.setMemberserialnumber(rs.getInt("member_serial_number"));
				blacklistVO.setBlackliststatus(rs.getBoolean("black_list_status"));
			}
	...
	public List<BlacklistVO> getAll() {
		...
		try {
			...
			while (rs.next()) {
				...
				blacklistVO.setMemberserialnumber(rs.getInt("member_serial_number"));
				blacklistVO.setBlackliststatus(rs.getBoolean("black_list_status"));
				blacklistVO.setAccount(rs.getString("member_account"));
