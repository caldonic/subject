...
//		"INSERT INTO item_category (item_category_main_name,item_category_area_name,item_category_detail_name) VALUES (?, ?, ?)";
	private static final String GET_ALL_STMT = 
		"SELECT item_serial_number,item_name,item_description,item_price,item_stock,seller_serial_number,item_category_number,item_status_number FROM item order by item_serial_number";
	private static final String GET_ONE_STMT = 
		"SELECT item_serial_number,item_name,item_description,item_price,item_stock,seller_serial_number,item_category_number,item_status_number FROM item where item_serial_number = ?";
