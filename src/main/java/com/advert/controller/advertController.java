...
//				Integer adminserialnumber = Integer.valueOf(req.getParameter("adminserialnumber"));
				Integer adminserialnumber = ((AdmBean)req.getSession().getAttribute("user")).getAdmid();
//				Integer itemserialnumber = Integer.valueOf(req.getParameter("itemserialnumber"));
...
//					Integer advertserialnumber = null;
//					try {
//					Integer	advertserialnumber = Integer.valueOf(req.getParameter("advertserialnumber").trim());
//					} catch (NumberFormatException e) {	
//						System.out.println("沒抓到廣告流水編號!!");
//					}
					
//					Integer adminserialnumber = null;
//					try {
//					Integer adminserialnumber = Integer.valueOf(req.getParameter("adminserialnumber").trim());
//					} catch (NumberFormatException e) {	
//						System.out.println("沒抓到維護人員編號!!");
//					}
...
//		            }
//					String advertdescription = String.valueOf(req.getParameter("advertdescription"));
					String advertdescription = req.getParameter("advertdescription");
					if (advertdescription == null || advertdescription.trim().length() == 0) {
						errorMsgs.add("廣告敘述請勿空白");
					}											
...
//					Integer itemserialnumber = null;
//					try {
//					Integer	itemserialnumber = Integer.valueOf(req.getParameter("itemserialnumber").trim());
//					} catch (NumberFormatException e) {	
