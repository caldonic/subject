...
<!-- 		                        </select> -->
							...
							<div class="row">
								<div class="col-12">
									<div class="form-group">
										<label>商品編號</label> <input type="TEXT" name="itemserialnumber"
...
<%-- 								<input type="hidden" name="advertphoto" value="<%=advertvo.getAdvertphoto()%>"> --%>
								<input class="btn  btn-primary" type="submit" value="送出修改" onClick="updcfm()">
							</div>
						</div>
					</FORM>	
<!-- 						</div> -->
