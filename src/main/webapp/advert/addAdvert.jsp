            ...
            >
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="./blmemberall.jsp" class="nav-link">
              ...
              <li class="nav-item ">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="../advert/Advert.jsp" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>首頁廣告</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="./couponall.jsp" class="nav-link ">
                      <i class="far fa-circle nav-icon"></i>
                      <p>優惠劵</p>
                    </a>
                  </li>                  
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="./froann.jsp" class="nav-link">
                      <i class="far fa-circle nav-icon "></i>
                      <p>首頁公告</p>
                    </a>
                  </li>
         ...
         <div class="container-fluid">
           <div class="row mb-2">
             <div class="card-header py-2">
               <h3 class="m-0 font-weight-bold">新 增 廣 告</h3>
            </div>
			</div>
			<div class="row mb-2">
             <!-- /.col -->
...
<!-- 			                        </select> -->
								...
								<div class="row">
									<div class="col-12">
										<div class="form-group">
											<label>商品圖片：</label> <input type="file" id="Picfile"
...
<!-- 						</div> -->
						...
						<div class="row">
							<div class="col-3">
								...
								<input class="btn  btn-primary" type="submit" value="新增廣告">
							</div>
				  		</div>
					</FORM>
				</div>              
