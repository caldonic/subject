																	...
																	<div class="tab-pane" id="timeline">
																		...
																		<c:if test="${not empty errorMsgs}">
																			...
																			<div class="card-body">
																				 ...
																				 <input type="hidden" name="item_serial_number" value="<%=itemvo.getSerialnumber()%>">	
																                       ...
																                       <div class="form-group">
																                        ...
																                        <select
																                         ...
																                         <c:forEach var="Itemcatevo" items="${itemcateSvc.all}">
																                          <option value="${itemvo.categoryno}" ${("itemvo.categoryno" eq "Itemcatevo.categoryno")? "selected":''} >
																		...
																		<div class="row justify-content-end">
																			<input type="hidden" name="action"
																				value="update">
																			<input class="btn  btn-primary" type="submit" value="更新商品資訊">
																			</div>
																			</FORM>
