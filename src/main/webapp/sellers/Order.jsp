...
<%}%>
                                                      <c:forEach var="orderMainFileVO" items="${list}"
                                                        begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
                                          <tr>
                                            <td>${orderMainFileVO.orderserialnumber}</td>
                                            <td>${orderMainFileVO.memberserialnumber }</td>
                                            <td>${orderMainFileVO.orderstatusnumber }</td>
                                            <td>${orderMainFileVO.orderamount }</td>
                                            <td>${orderMainFileVO.orderdate }</td>
                                            <td>${orderMainFileVO.sellerevaluationdescription}</td>
                                            <td>
                                              <FORM METHOD="post"
                                                ACTION="<%=request.getContextPath()%>/sellers/sellerOrderMain"
                                                style="margin-bottom: 0px;">
                                                <input type="submit" value="查看" class="btn  btn-primary">
                                                <input type="hidden" name="orderserialnumber"
                                                  value="${orderMainFileVO.orderserialnumber}"> <input type="hidden"
                                                  name="action" value="getDetail_For_Display">
                                              </FORM>
                                            </td>
                                          </tr>
                                          </c:forEach>
