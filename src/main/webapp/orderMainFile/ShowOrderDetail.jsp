		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-9">
							...
							<c:forEach var="OrderDetailVO" items="${listOrderDetail}"
								...
								<c:if
									...
									<tr>
										...
										<%-- <td><img alt="" 
 											src="data:image/jpeg;base64,<%out.print(Base64.getEncoder().encodeToString(listOrderDetail.get(0).getPhoto()));%>">
									    </td> --%>
										<td>
					...
					<input type="button" value="回上一頁" onclick="location.href='listAllOrderMainFile.jsp'">
					<!-- OrderDetail End -->
				</div>
			</div>
		</div>
