            ...
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <!-- <div class="card card-primary"> -->
                  ...
                  <!-- /.card-header -->
                  <!-- form start -->
                 <FORM METHOD="post" ACTION="${pageContext.request.contextPath}/administrator/froann.do" name="form1">
                      <table>
                        <tr>
                          <td>維護人編號</td>
                          <td><input type="TEXT" name="admno" size="45" 
                             value="" /></td>
                        </tr>
                        <tr>
                          <td>內容</td>
                          <td><input type="TEXT" name="froanndesc" id="froanndesc" size="45"
                             value="" /></td>
                        </tr>
                        <tr>
                          <td>開始日期</td>
                          <td><input name="froannsdate" id="f_date1" type="text" size="45" /></td>
                        </tr>
                        <tr>
                          <td>結束日期</td>
                          <td><input name="froannedate" id="f_date2" type="text" size="45" />
                            </td>
                        </tr>
                        <tr>
                          <td>上架狀態</td>
                          <td><input type="TEXT" name="froannstatus" size="45"
                             value="" /></td>
                        </tr>
                      
<%--                         <jsp:useBean id="deptSvc" scope="page" class="subject.service.FroannService" /> --%>
                        <tr>
