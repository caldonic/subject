...
<%-- 此頁採用 EL 的寫法取值 --%>
<%
FroannVO froannVO = (FroannVO) request.getAttribute("froannVO");
%>
<!DOCTYPE html>
<!--
          ...
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="./index_memberaudit.html" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>會員審核</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="./index_memberpermission.html" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>權限管理</p>
                    </a>
                  </li>
              ...
              <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="./froann.html" class="nav-link active">
                      <i class="far fa-circle nav-icon "></i>
                      <p>首頁公告</p>
                    </a>
                  </li>
...
<c:if test="${not empty errorMsgs}">
   ...
   <FORM METHOD="post" ACTION="froann.do" name="form1">
<table>
<!-- 	<tr> -->
<!-- 		<td>公告編號:<font color=red><b>*</b></font></td> -->
<%-- 		<td><%=froannVO.getFroannno()%></td> --%>
<!-- 	</tr> -->
	<tr>
		<td>公告編號:<font color=red><b></b></font></td>
		<td>${froannVO.froannno}</td>
	</tr>
	<tr>
		<td>維護人編號:<font color=red><b></b></font></td>
		<td>${froannVO.admno}</td>
	</tr>
	<tr>
		<td>內容:<font color=red><b></b></font></td>
		<td><input type="TEXT" name="froanndesc" size="60" value="<%=froannVO.getFroanndesc()%>" /></td>
		
	</tr>
	<tr>
		<td>開始日期:<font color=red><b></b></font></td>
		<td><fmt:formatDate  value="${froannVO.froannsdate}" pattern="yyyy-MM-dd"/></td>

<%-- 		<td>${froannVO.froannsdate}</td> --%>
	</tr>
	<tr>
		<td>結束日期:<font color=red><b></b></font></td>
		<td>${froannVO.froannedate}</td>
	</tr>
	<tr>
		<td>狀態:<font color=red><b></b></font></td>
		<td>${froannVO.froannstatus == 0 ? "on" : "off"}</td>
	</tr>
...
<input type="submit" value="送出修改"></FORM>
    ...
    <script src="./js/index_coupon.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.13.0/js/all.min.js"></script>
  </body>
    <% 
  java.sql.Date froannsdate = null;
  try {
	  froannsdate = froannVO.getFroannsdate();
   } catch (Exception e) {
...
%>
 <% 
  ...
  try {
	  froannedate = froannVO.getFroannedate();
   } catch (Exception e) {
  ...
  .xdsoft_datetimepicker .xdsoft_timepicker .xdsoft_time_box {
	...
	<script>
        ...
        $('#f_date1').datetimepicker({
		   ...
		   value: '<%=froannsdate%>', // value:   new Date(),
        ...
        $('#f_date2').datetimepicker({
	       ...
	       step: 1,                //step: 60 (這是timepicker的預設間隔60分鐘)
	       format:'Y-m-d',         //format:'Y-m-d H:i:s',
		   value: '<%=froannedate%>', // value:   new Date(),
           //disabledDates:        ['2017/06/08','2017/06/09','2017/06/10'], // 去除特定不含
           //startDate:	            '2017/07/10',  // 起始日
           //minDate:               '-1970-01-01', // 去除今日(不含)之前
           //maxDate:               '+1970-01-01'  // 去除今日(不含)之後
