...
<class class="hold-transition sidebar-mini">
  ...
  <button><a href='addBlacklist.jsp'>新增黑名單</a></button>
  <br>
	<br>
...
<table>
	<tr style="background-color: rgb(0,123,255); color:white">
		<th>黑名單編號</th>
		<th>賣家流水編號</th>
		<th>帳號</th>
<!-- 		<th>會員流水編號</th> -->
...
const blockHash = `#settings`;
// const addbutton = `addBlacklist.jsp`

// 抓到所有的a.nav-link的html標籤
const aTags = [...document.getElementsByClassName("nav-link")];
// const bTags = [...document.getElementsByClassName("addbtn")];

// 找到第一個href裡面有blockHash的a標籤
const blockTag = aTags.find((a) => (a.href + '').includes(blockHash));
// const addTag = bTags.find((a) => (a.href + '').includes(addbutton));
