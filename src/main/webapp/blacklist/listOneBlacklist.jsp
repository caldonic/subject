...
<%
  BlacklistVO blacklistVO = (BlacklistVO) request.getAttribute("blacklistVO"); //EmpServlet.java(Concroller), 存入req的empVO物件
%>
...
<!-- 		<th>會員流水編號</th> -->
	...
	<tr>
		<td><%=blacklistVO.getBlacklistnumber()%></td>
		<td><%=blacklistVO.getSerialnumber()%></td>
		<td><%=blacklistVO.getAccount()%></td>
		<td><%=blacklistVO.isBlackliststatus()%></td>
<%-- 		<td><%=blacklistVO.getMemberserialnumber()%></td> --%>
	</tr>
</table>
</table>
<br>
